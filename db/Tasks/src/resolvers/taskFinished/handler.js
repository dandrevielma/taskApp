 ...
 *    8base invoke-local taskFinished -p src/resolvers/taskFinished/mocks/request.json
 *
 *  (2) Default mock file location using -m flag:
 *    8base invoke-local taskFinished -m request
 *
 ...
 *    8base generate mock taskFinished -m [MOCK_FILE_NAME]
 */
