...
const DeleteIcon = (props) => {
    return (<svg id="Layer_4" data-name="Layer 4" fill={props.color} width={props.width} height={props.height} viewBox="0 0 600 600"><polygon className="cls-1" points="452.39 194.51 405.5 147.63 300 253.11 194.5 147.63 147.61 194.51 253.11 300 147.61 405.49 194.5 452.38 300 346.89 405.5 452.38 452.39 405.49 346.89 300 452.39 194.51"/></svg>)
}
...
const CheckIcon = (props) => {
    return (<svg id="Layer_4" data-name="Layer 4" fill={props.color} width={props.width} height={props.height} viewBox="0 0 600 600"><defs><style>.cls-1</style></defs><polygon className="cls-1" points="227.94 456.88 128.65 357.58 175.54 310.69 227.94 363.1 424.46 166.58 471.35 213.47 227.94 456.88"/></svg>)
}